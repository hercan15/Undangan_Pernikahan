  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await addMessage({
        ...
        guests: attendance === "hadir" ? guests : undefined,
        message,
      });
  ...
  return (
    <section id="rsvp" className="py-section-gap px-gutter">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div
          className="max-w-lg mx-auto scroll-trigger opacity-0 translate-y-10"
        ...
        >
          {submitted ? (
            <div className="glass-card-static rounded-2xl p-10 text-center">
              ...
              <h3 className="font-playfair text-[28px] text-secondary mb-3">
                Terima Kasih!
              </h3>
              <p className="font-inter text-[16px] text-on-surface-variant">
                Konfirmasi kehadiran Anda telah terkirim melalui WhatsApp, dan
                ucapan ini kini tampil di seksi Ucapan & Doa.
              </p>
              <button
                onClick={resetForm}
            ...
            <form
              ...
              className="glass-card-static rounded-2xl p-8 md:p-10 space-y-6"
            >
              {/* Name */}
              <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-xl border font-inter text-[14px] font-semibold transition-all cursor-pointer ${
                      attendance === "hadir"
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full flex items-center justify-center gap-3 bg-secondary text-on-secondary py-4 rounded-xl font-inter text-[14px] tracking-[0.1em] font-semibold uppercase hover:opacity-90 active:scale-[0.98] transition-all cursor-pointer disabled:opacity-50"
              >
                {sending ? (
                  "Mengirim..."
                ) : (
